          ...
          <button onClick={() => navigate('/profile')}>
            <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center"
              ...
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
                <circle cx="13" cy="13" r="13" fill="#E8F5E9" />
                <circle cx="13" cy="10" r="4.5" fill="#4CAF50" />
                <path d="M4 23 C4 17 22 17 22 23" fill="#4CAF50" />
              </svg>
            </div>
          </button>
        </div>
        ...
        <div className="px-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-base font-bold text-primary">{fieldStatus.healthyPercent}%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-bold text-gray-900">Season Tracker</p>
          ...
          <div className="card p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button className="text-xs text-primary font-semibold" onClick={() => navigate('/crop-status')}>
                View Map →
              </button>
            </div>
          ...
          <div className="card p-4 mb-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button className="text-xs text-primary font-semibold" onClick={() => navigate('/alerts')}>
                View All →
              </button>
            </div>
