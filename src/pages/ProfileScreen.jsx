      ...
      <div className="flex-1 overflow-y-auto pb-1">
        ...
        <div className="px-4 space-y-3">
              ...
              <div className="flex-shrink-0" style={{ width: 64, height: 64 }}>
                ...
                <div style={{
                  ...
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                    <circle cx="20" cy="16" r="7" fill="#66BB6A"/>
                    <path d="M4 38C4 28 36 28 36 38" fill="#66BB6A"/>
                  </svg>
                </div>
              </div>
              <div>
          ...
          <div className="card p-4">
            ...
            <SettingRow icon={Settings} label="Settings"      iconBg="#F3F4F6" iconColor="#6B7280" onClick={() => navigate('/settings')} />
            <SettingRow icon={Bell}     label="Notifications" iconBg="#FFF3E0" iconColor="#FB8C00" onClick={() => navigate('/notifications')} />
            <SettingRow icon={LogOut}   label="Logout"        danger onClick={() => navigate('/')} />
          </div>
