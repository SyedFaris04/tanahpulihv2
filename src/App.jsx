...
import StakeholderFarmsScreen from './pages/StakeholderFarmsScreen'
import StakeholderReportsScreen from './pages/StakeholderReportsScreen'
    ...
    <div className="phone-frame">
      ...
      <div className="screen-container">
        <Routes>
          ...
          <Route path="/stakeholder/farms"    element={<StakeholderFarmsScreen />} />
          <Route path="/stakeholder/reports"  element={<StakeholderReportsScreen />} />
